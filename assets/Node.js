...
// __dirname is the folder containing this file (assets/)
...
const server = http.createServer((req, res) => {
    ...
    if (pathname === '/' || pathname === '/browser' || pathname === '/index.html') {
        ...
        try {
            ...
            req.on('end', () => {
                const proxyReq = protocol.request(options, (proxyRes) => {
                    const headers = {};
                    const forwardHeaders = ['content-type', 'content-length', 'cache-control', 'etag', 'last-modified', 'content-encoding'];
